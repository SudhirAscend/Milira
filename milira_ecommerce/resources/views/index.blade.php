        ...
        <div class="product-categories">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pendemt-tab" data-bs-toggle="pill" data-bs-target="#pendemt" type="button" role="tab" aria-controls="pendemt" aria-selected="true">Pendemt Set</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="chain-tab" data-bs-toggle="pill" data-bs-target="#chain" type="button" role="tab" aria-controls="chain" aria-selected="false">Chain</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="stud-tab" data-bs-toggle="pill" data-bs-target="#stud" type="button" role="tab" aria-controls="stud" aria-selected="false">Stud</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="earrings-tab" data-bs-toggle="pill" data-bs-target="#earrings" type="button" role="tab" aria-controls="earrings" aria-selected="false">Earrings</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="bracelet-tab" data-bs-toggle="pill" data-bs-target="#bracelet" type="button" role="tab" aria-controls="bracelet" aria-selected="false">Bracelet</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="necklace-tab" data-bs-toggle="pill" data-bs-target="#necklace" type="button" role="tab" aria-controls="necklace" aria-selected="false">Necklace</button>
                </li>
              </ul>
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pendemt" role="tabpanel" aria-labelledby="pendemt-tab" tabindex="0">
                    <div class="row">
                ...
                <div class="tab-pane fade" id="chain" role="tabpanel" aria-labelledby="chain-tab" tabindex="0">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mt-4">
                            <div class="card product">
                                <div class="card-body">
                                    <img src="./assets/images/product/product_2.png" alt="" class="pdt-img">
                                    <div class="container">
                                        <div class="pdt-title">
                                            <h6>Embellished Diamond and White Gold Necklace Set</h6>
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mt-4">
                            <div class="card product">
                                <div class="card-body">
                                    <img src="./assets/images/product/product_3.png" alt="" class="pdt-img">
                                    <div class="container">
                                        <div class="pdt-title">
                                            <h6>Embellished Diamond and White Gold Necklace Set</h6>
                                        </div>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="pdt-shop text-center mt-5">
                                            <button class="cart-btn">Add to Cart <i class="bi bi-cart-check-fill"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                ...
                <div class="tab-pane fade" id="stud" role="tabpanel" aria-labelledby="stud-tab" tabindex="0">3</div>
                <div class="tab-pane fade" id="earrings" role="tabpanel" aria-labelledby="earrings-tab" tabindex="0">4</div>
                <div class="tab-pane fade" id="bracelet" role="tabpanel" aria-labelledby="bracelet-tab" tabindex="0">5</div>
                <div class="tab-pane fade" id="necklace" role="tabpanel" aria-labelledby="necklace-tab" tabindex="0">6</div>
              </div>
        </div>
    </div>
    ...
    <div class="container feature">
        ...
        <div class="featureSlider">
            <div class="feature-img">
                <div class="card mx-3">
                    <div class="card-body">
                        <img src="./assets/images/shop/product1.jpg" alt="Feature Products" loading="lazy">
                        <div class="container">
                            <div class="f-title">
                                <h6>Embellished Diamond and White Gold Necklace Set</h6>
                            </div>
            ...
            <div class="feature-img">
                <div class="card mx-3">
                    <div class="card-body">
                        <img src="./assets/images/shop/product2.jpg" alt="Feature Products" loading="lazy">
                        <div class="container">
                            <div class="f-title">
                                <h6>Embellished Diamond and White Gold Necklace Set</h6>
                            </div>
            ...
            <div class="feature-img">
                <div class="card mx-3">
                    <div class="card-body">
                        <img src="./assets/images/shop/product3.jpg" alt="Feature Products" loading="lazy">
                        <div class="container">
                            <div class="f-title">
                                <h6>Embellished Diamond and White Gold Necklace Set</h6>
                            </div>
