...
<body>
    ...
    <span class="cart-icon" id="cart-icon">
            <svg width="35" height="28" viewBox="0 0 35 28" fill="none" xmlns="http://www.w3.org/2000/svg" id="cart-svg">
            ...
            <span class="cart-count" id="cart-text-count">{{ count(session('cart', [])) }}</span>
        </span>
    ...
    <div class="cart-submenu">
            ...
            <div class="wrapper">
                <div class="wrapper-item">
                    <div class="wrapper-img">
                        <img src="{{ asset('storage/uploads/' . $item['name'] . '_0.jpg') }}" alt="img">
                    </div>
        ...
        <div class="cart-wrapper-section">
            ...
            <div class="wrapper-subtotal">
                ...
                <h5 class="wrapper-title" id="cart-subtotal">
...
$(document).ready(function() {
    $('.cart-btn').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                updateCartDetails(response.cart, response.subtotal);
            },
    ...
    function updateCartDetails(cart, subtotal) {
        let cartCount = Object.keys(cart).length;
        $('.header-cart .cart-item .cart-text').text(`Cart (${cartCount})`);

        let cartWrapper = $('.cart-wrapper-item');
        cartWrapper.empty();
        ...
        $('.wrapper-subtotal .wrapper-title').last().text(`₹${subtotal}`);
    }
});
</script>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCartUI() {
            ...
            const itemCount = parseInt(cartCount.innerText);
            
            if (itemCount > 0) {
                cartSvg.classList.remove('cart-icon-grey');
                cartSvg.classList.add('cart-icon-red');
                cartCount.classList.remove('cart-count-grey');
                cartCount.classList.add('cart-count-red');
            } else {
                cartSvg.classList.remove('cart-icon-red');
                cartSvg.classList.add('cart-icon-grey');
                cartCount.classList.remove('cart-count-red');
                cartCount.classList.add('cart-count-grey');
            }
        }
        ...
        document.getElementById('remove-from-cart-button').addEventListener('click', removeItemFromCart);
    });
</script>
<script>
    document.addEventListener('DOMContentLoaded', function() {
