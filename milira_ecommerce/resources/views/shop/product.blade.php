        ...
        <div class="row text-center">
            ...
            <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                <div class="p-4 border rounded shadow-sm w-100">
                    ...
                    <h5 class="mb-2" style="font-size: 1.5rem;">Free Shipping around India</h5>
                </div>
            </div>
            <!-- Box 2 -->
            <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                <div class="p-4 border rounded shadow-sm w-100">
                    <i class="bi bi-gem fs-1 mb-3 text-dark"></i>
                    <h5 class="mb-2" style="font-size: 1.5rem;">Free 1 Gram Silver for Purchase above 5000</h5>
                </div>
            </div>
            <!-- Box 3 -->
            <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                <div class="p-4 border rounded shadow-sm w-100">
                    ...
                    <h5 class="mb-2" style="font-size: 1.5rem;">Secure Payment Gateway</h5>
                </div>
            </div>
        </div>
    </div>
