...
.product-buy-btn {
    background-color: #ff5722; /* Old background color */
    color: #fff; /* Old text color */
    border: none; /* No border */
    padding: 10px 20px; /* Old padding */
    border-radius: 4px; /* Old border radius */
    font-size: 16px; /* Old font size */
    cursor: pointer; /* Old cursor style */
    display: inline-flex; /* Aligning the icon and text */
    align-items: center; /* Centering the icon and text */
    transition: background-color 0.3s; /* Smooth transition for hover effect */
}

.product-buy-btn i {
    margin-left: 10px; /* Old spacing between text and icon */
}
