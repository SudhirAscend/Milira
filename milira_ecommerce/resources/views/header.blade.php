...
@media (max-width: 768px) {
 ...
 <header id="header" class="header">
            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        ...
                        <a href="/profile"><span>Track Order</span></a>
                    </div>
    ...
    <div id="search-results" class="search-results"></div>
                       ...
                       <!--  <div class="header-compaire">
                        ...
                        <div class="header-favourite">
                                ...
                                <span class="wishlist-count" id="wishlist-item-count">
    {{ $wishlistCount ?? 0 }}
</span>
                                    <span>
    ...
    <span class="cartcount" id="cart-item-count">{{ $cartCount ?? 0 }}</span>
    ...
    @guest
        <span>
            <button class="d-flex" id="auth-switch">
                <a href="/login" class="loginclr active" >Login</a>
                        ...
                        @auth
                            <div class="dropdown">
                                <span style="display: flex; align-items: center;" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <p style="margin: 0; width: 15rem;">Hi, <b>{{ Auth::user()->full_name }}</b></p>
                                </span>
